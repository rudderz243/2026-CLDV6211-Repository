...
namespace DeleteConstraintExampleG1.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public StudentsController(StudentG1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            // using LINQ, check the middle table to find any records corresponding to the student we are deleting
            bool studentHasModules = await _context.ModuleStudents.AnyAsync(ms => ms.StudentId == id);
            // if the student still has modules,
            if (studentHasModules) {
                // create error
                ModelState.AddModelError("StudentId", "This student still has modules assigned.");
                // return error
