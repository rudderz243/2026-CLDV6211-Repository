...
namespace DeleteConstraintExampleG2.Controllers
{
    public class ModuleStudentsController : Controller
    {
        ...
        public ModuleStudentsController(StudentG2Context context)
        {
            _context = context;
        }
        ...
        {
            var studentG2Context = _context.ModuleStudents.Include(m => m.Module).Include(m => m.Student);
            return View(await studentG2Context.ToListAsync());
        }
